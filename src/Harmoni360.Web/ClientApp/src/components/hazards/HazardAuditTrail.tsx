...
interface HazardAuditTrailProps {
  hazardId: number;
}
...
const getActionIcon = (action: string) => {
  switch (action) {
    ...
    case 'Attachment Removed':
      return faTrash;
    case 'Risk Assessment Added':
    case 'Risk Assessment Updated':
      return faShieldAlt;
    case 'Mitigation Action Added':
    case 'Mitigation Action Updated':
      return faTasks;
    case 'Mitigation Action Removed':
      return faTrash;
    case 'Comment Added':
      return faComment;
    case 'Exported':
...
const formatChangeText = (auditLog: HazardAuditLogDto): string => {
...
const HazardAuditTrail: React.FC<HazardAuditTrailProps> = ({
  hazardId,
}) => {
  const {
    data: auditLogs = [],
    isLoading,
    error,
  } = useGetHazardAuditTrailQuery(hazardId);
...
export default HazardAuditTrail;