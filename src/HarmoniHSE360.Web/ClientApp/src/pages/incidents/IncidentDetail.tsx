...
const IncidentDetail: React.FC = () => {
  ...
  const { data: incident, error, isLoading } = useGetIncidentDetailQuery(Number(id));
            ...
            <div>
              ...
              >
                {isDeleting ? (
                  ...
                  <>
                    <Icon icon={ACTION_ICONS.delete} size="sm" className="me-2" />
                    Delete
                  </>
                )}
              </CButton>
            ...
            <CRow>
                ...
                <CRow className="mb-4">
                  <CCol sm={6}>
                    <h6 className="text-muted">
                      <Icon icon={CONTEXT_ICONS.date} size="sm" className="me-1" />
                      Incident Date
                    </h6>
                  ...
                  <CCol sm={6}>
                    <h6 className="text-muted">
                      <Icon icon={CONTEXT_ICONS.location} size="sm" className="me-1" />
                      Location
                    </h6>
              ...
              <CCol md={4}>
                <div className="border-start ps-4">
                  ...
                  <div className="mb-3">
                    <FontAwesomeIcon icon={CONTEXT_ICONS.reporter} size="sm" className="me-2" />
                  ...
                  <CListGroup className="mb-4 related-info-mobile">
                    ...
                    >
                      ...
                      <CBadge color="info">{incident.involvedPersons?.length || 0}</CBadge>
                    </CListGroupItem>
                    <CListGroupItem 
                      className="d-flex justify-content-between cursor-pointer position-relative"
                  ...
                  {(incident.attachmentsCount === 0 && incident.involvedPersons?.length === 0 && incident.correctiveActionsCount === 0) && (
