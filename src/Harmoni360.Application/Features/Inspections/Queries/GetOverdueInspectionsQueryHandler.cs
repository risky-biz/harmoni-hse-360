...
public class GetOverdueInspectionsQueryHandler : IRequestHandler<GetOverdueInspectionsQuery, PagedList<InspectionDto>>
{
    private readonly IApplicationDbContext _context;

    public GetOverdueInspectionsQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<PagedList<InspectionDto>> Handle(GetOverdueInspectionsQuery request, CancellationToken cancellationToken)
    {
        var query = _context.Inspections
            ...
            .Where(i => i.Status == InspectionStatus.Scheduled && i.ScheduledDate < DateTime.UtcNow)
            .AsQueryable();
        ...
        query = request.SortBy.ToLower() switch
        {
            ...
            "department" => request.SortDescending 
                ? query.OrderByDescending(i => i.Department!.Name)
                : query.OrderBy(i => i.Department!.Name),
