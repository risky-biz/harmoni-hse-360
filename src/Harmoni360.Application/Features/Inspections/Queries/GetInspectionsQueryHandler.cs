...
public class GetInspectionsQueryHandler : IRequestHandler<GetInspectionsQuery, PagedList<InspectionDto>>
{
    ...
    public async Task<PagedList<InspectionDto>> Handle(GetInspectionsQuery request, CancellationToken cancellationToken)
    {
